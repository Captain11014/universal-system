...
import com.universal.system.common.constant.UserConstants;
import com.universal.system.common.exception.UniversalException;
import com.universal.system.common.result.HttpStatus;
import com.universal.system.common.utils.DictUtils;
import com.universal.system.common.utils.StringUtils;
import com.universal.system.mapper.SysDictDataMapper;
import com.universal.system.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements SysDictTypeService
{
    ...
    public void deleteDictTypeByIds(Long[] dictIds)
    {
        for (Long dictId : dictIds)
        {
            ...
            {
                throw new UniversalException(HttpStatus.ERROR,String.format("%1$s已分配,不能删除", dictType.getDictName()));
            }
